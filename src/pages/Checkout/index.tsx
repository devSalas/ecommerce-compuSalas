...
const Checkout = () => {
  ...
  return (
    <>
    <button onClick={handleClickAgregarProducts}>
        agregar datos
    </button>
    <div className="min-w-screen min-h-screen bg-gray-50 py-5">
        <div className="px-5">
            ...
            <div className="mb-2">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-600">Bolsa de Compras.</h1>
            </div>
            <div className="mb-5 text-gray-400">
                <a href="#" className="focus:outline-none hover:underline text-gray-500">Home</a> / <a href="#" className="focus:outline-none hover:underline text-gray-500">Cart</a> / <span className="text-gray-600">Bolsa de Compras</span>
            </div>
        </div>
                    ...
                    <div className="px-3 md:w-5/12">
                        ...
                        <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 text-gray-800 font-light mb-6 flex justify-between p-4 ">
                            ...
                            <div className="flex flex-col text-end">
                                ...
                                <span>s/23434</span>
                                <span>Gratis</span>
                                <span><strong>s/1,650.92</strong></span>
                            </div>
