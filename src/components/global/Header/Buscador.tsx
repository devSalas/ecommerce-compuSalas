...
export default function Buscador() {
  ...
  return (
    <form onSubmit={handleSubmit} className="group flex justify-between w-full md:max-w-lg">
        <div className='w-full flex px-4 border  group-hover:border-neutral-400'>
          <input className='w-full outline-none' type="search" name="" id="" placeholder='buscar'/>
